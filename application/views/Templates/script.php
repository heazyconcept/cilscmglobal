<script src="<?php echo asset_url('vendor/babel-external-helpers/babel-external-helpers599c.js?v4.0.2') ?>"></script>
  <script src="<?php echo asset_url('vendor/jquery/jquery.min599c.js?v4.0.2') ?>"></script>
  <script src="<?php echo asset_url('vendor/popper-js/umd/popper.min599c.js?v4.0.2') ?>"></script>
  ...
  <script src="<?php echo asset_url('vendor/jquery-placeholder/jquery.placeholder599c.js?v4.0.2') ?>"></script>
  <script src="<?php echo asset_url('vendor/alertify/alertify599c.js?v4.0.2') ?>"></script>
   <script src="<?php echo asset_url('vendor/chartist/chartist.min599c.js?v4.0.2') ?>"></script>
  <script src="<?php echo asset_url('vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.min599c.js?v4.0.2') ?>"></script>
  <script src="<?php echo asset_url('vendor/aspieprogress/jquery-asPieProgress.min599c.js?v4.0.2') ?>"></script>
  <script src="<?php echo asset_url('vendor/matchheight/jquery.matchHeight-min599c.js?v4.0.2') ?>"></script>
  <script src="<?php echo asset_url('vendor/jquery-selective/jquery-selective.min599c.js?v4.0.2') ?>"></script>
  <script src="<?php echo asset_url('vendor/bootstrap-datepicker/bootstrap-datepicker.min599c.js?v4.0.2') ?>"></script>
  ...
  <script src="<?php echo asset_url('js/jquerymy-1.2.16.js') ?>"></script>
  ...
  <script src="<?php echo asset_url('js/Plugin/jquery-placeholder.min599c.js?v4.0.2') ?>"></script>
  <script src="<?php echo asset_url('js/Plugin/alertify.min599c.js?v4.0.2') ?>"></script>
   <script src="<?php echo asset_url('js/Plugin/matchheight.min599c.js?v4.0.2') ?>"></script>
  <script src="<?php echo asset_url('js/Plugin/aspieprogress.min599c.js?v4.0.2') ?>"></script>
  <script src="<?php echo asset_url('js/Plugin/bootstrap-datepicker.min599c.js?v4.0.2') ?>"></script>
  <script src="<?php echo asset_url('js/Plugin/asscrollable.min599c.js?v4.0.2') ?>"></script>
  <script src="<?php echo asset_url('js/Plugin/datatables.min599c.js?v4.0.2') ?>"></script>
  <script src="<?php echo asset_url('examples/js/dashboard/team.min599c.js?v4.0.2') ?>"></script>
  <script src="<?php echo asset_url('examples/js/tables/datatable.min599c.js?v4.0.2') ?>"></script>
